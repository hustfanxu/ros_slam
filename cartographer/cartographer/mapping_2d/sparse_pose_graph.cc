...
//  LOG(INFO)<<"first_transform_index  :   "<<first_transform_index;
 ...
 /*   const transform::Rigid2d  submap_pose_0=sparse_pose_graph::ComputeSubmapPose(*submaps[0]);
    Eigen::Rotation2D<double> p_r_0=submap_pose_0.rotation();
    const transform::Rigid2d  submap_pose_0_inv=sparse_pose_graph::ComputeSubmapPose(*submaps[0]).inverse();
    Eigen::Rotation2D<double> p_r_1=submap_pose_0_inv.rotation();
    LOG(INFO)<<"submap_pose_0 _translation :   "<<submap_pose_0.translation();
    LOG(INFO)<<"submap_pose_0 _rotation :   "<<p_r_0.angle();
    LOG(INFO)<<"submap_pose_0_inv _translation :   "<<submap_pose_0_inv.translation();
    LOG(INFO)<<"submap_pose_0_inv _rotation :   "<<p_r_1.angle();*/
...
void SparsePoseGraph::ComputeConstraintsForScan(
  ...
  //      cout<< "trajectory_nodes_[scan_index].constant_data->laser_fan.point_cloud.size()  :  "<<trajectory_nodes_[scan_index]
    //             .constant_data->laser_fan.point_cloud.size()<<endl;
      } else {
