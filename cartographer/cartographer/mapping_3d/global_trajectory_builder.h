...
class GlobalTrajectoryBuilder
 ...
 public:
  ...
  void AddGpsData(int64 timestamp, const cartographer::transform::Rigid2d& gps_data,
                  const cartographer::transform::Rigid2d& gps_data_covariance,int gps_flag) override
                  {

                  }
  void recieve_commond(int64 timestamp,bool commond,int32_t count_mark,bool draw_offline)override
  {
  ...
  bool read_commond() override
  {
        return 1;
  }

  bool draw_or_offline() override
  {
      return 1;
  }
