...
int MapBuilder::AddTrajectoryBuilder() {
  if (options_.use_trajectory_builder_3d()) {
    ...
    trajectory_builders_.push_back(
     ...
     cartographer::mapping_2d::proto::LocalTrajectoryBuilderOptions  my_options_1=  options_.trajectory_builder_2d_options();
     cartographer::mapping_2d::proto::SubmapsOptions  my_options_2=  my_options_1.submaps_options();


     LOG(INFO)<<"resolution : "<<my_options_2.resolution();
