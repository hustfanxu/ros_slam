 ...
 public:
  ...
  struct PoseEstimate {
    ...
    PoseEstimate(common::Time time,
                 ...
                 const sensor::PointCloud& point_cloud,double my_pose_confidence,
		bool flag);
    ...
    double my_pose_confidence=0.0;
    bool low_confidence_sended=0;
  };
  ...
  virtual void recieve_commond(int64 timestamp,bool commond,int32_t count_mark,bool draw_offline) =0;
    virtual void send_low_confidence()=0;
  virtual bool read_commond() =0;

  virtual bool draw_or_offline() =0;
